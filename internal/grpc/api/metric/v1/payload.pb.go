...
func (x *Payload) GetData() *wrapperspb.BytesValue {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_payload_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x3a, 0x0a, 0x07, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x12,
...
var file_payload_proto_goTypes = []any{
	(*Payload)(nil),               // 0: collector.metric.v1.Payload
	(*wrapperspb.BytesValue)(nil), // 1: google.protobuf.BytesValue
}
var file_payload_proto_depIdxs = []int32{
	1, // 0: collector.metric.v1.Payload.data:type_name -> google.protobuf.BytesValue
